...
const index = () => {
    const [selectedShippingChoice, setSelectedShippingChoice] = useState("Standard")
  return (
    <div
      className="min-h-[685px] w-[400px] p-8 rounded shadow-[0_1px_1px_-1px_rgba(0,0,0,0.15),0_1px_2px_0_rgba(0,0,0,0.1),0_1px_4px_0_rgba(0,0,0,0.1)] 
    ml-12 mt-14 "
    >
      <RightHeadline />
      <ShippingChoice
